# Otoshi_Harvester/分析与考据

<!-- source html: G:\repos\THBWiki-Markdown-Builder\THBWikiMarkdown\Temp\main\b\b7\ns0%3AOtoshi_Harvester%2F%E5%88%86%E6%9E%90%E4%B8%8E%E8%80%83%E6%8D%AE.html -->
...
- [1 分析与考据](#分析与考据)
  ...
  - [1.1 豊符「オヲトシハーベスター」](#豊符「オヲトシハーベスター」)
  - [1.2 豊作「穀物神の約束」](#豊作「穀物神の約束」)
...
とし
    ...
    - 穂落伝承（穗落传说）[^cite_note-3]
      - 该传说见于《倭姬命世记》，与佐美长神社[^cite_note-4]的成立有关。
      - 传说倭姬命一行在志摩国巡游时，追随一只真名鹤[^cite_note-5]发现了一片丰实的稻田，还看见有真名鹤叼着稻子来回飞行，以将稻穗洒到地上。
...
<tbody><tr>
<th>《倭姬命世记》中的相关记载<sup id="cite_ref-6" class="reference"><a href="#cite_note-6">6</a></sup>
</th></tr>
<tr>
...
（谷物神）
  - 指本符卡的Easy / Normal版本[丰符「Otoshi Harvester」](./Otoshi_Harvester.md)中提到的“Otoshi”（大年神）。参见其分析考据 (未找到链接)。



[^cite_note-1]: 日文维基百科：[年神](https://en.wikipedia.org/wiki/ja:年神)
