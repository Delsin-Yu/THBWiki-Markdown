...
ろにいる（在你的背后）
  - 对应古明地恋的灵异梅莉小姐的电话。
  - 参见＊现在就给你打电话别忘了接哦＊ (未找到链接)的[分析考据](./现在就给你打电话别忘了接哦-分析与考据.md)。
...
（无意识）
  ...
  - 参见深层「无意识的基因」 (未找到链接)的[分析考据](./无意识的基因-分析与考据.md)。
...
（列祖列宗）
  - 可能与荣格心理学中的「集体无意识」[^cite_note-collective-unconscious-8]有关。
    ...
    - 古明地恋的另一张符卡深层「无意识的基因」 (未找到链接)可能也与此有关，参见[其分析考据](./无意识的基因-分析与考据.md)。
...
- スーパーエゴ
  ...
  - 关于本我、自我与超我，见本能「本我的解放」 (未找到链接)的[分析考据](./本我的解放-分析与考据.md)。
  - 超我是人格结构中的管制者，由道德原则支配，想要完美。

- 和对应本我的本能「本我的解放」 (未找到链接)是一对。
...
- ロールシャッハ
  ...
  - 和墨迹测试用图一样，符卡中的弹幕也是左右对称的。
    - 魔理沙的魔法书 (未找到链接)中对该符卡的[评价](./The_Grimoire_of_Marisa-古明地恋.md)：
...
（基因）
  - 一般音译为「基因」（Gene），指合成某种基因产物（RNA或蛋白质）所需的、来自DNA或RNA的核苷酸序列。
    ...
    - 参见记忆「DNA的瑕疵」 (未找到链接)的[分析考据](./DNA的瑕疵-分析与考据.md)。
...
- 无意识的基因
  - 可能与荣格心理学中的「集体无意识」有关。[^cite_note-collective-unconscious-8]
    ...
    - [古明地恋](./古明地恋.md)的另一张符卡表象「列祖列宗入梦来」 (未找到链接)可能也与此有关，参见[列祖列宗入梦来/分析与考据](./列祖列宗入梦来-分析与考据.md)。
...
われ<ruby lang="ja"><rb>者</rb><rp> (</rp><rt>もの</rt><rp>) </rp></ruby>
  ...
  - 被厌恶者，指[古明地恋](./古明地恋.md)。
    ...
    - 魔理沙的魔法书 (未找到链接)对该符卡的[评价](./The_Grimoire_of_Marisa-古明地恋.md)：
...
- フィロソフィ
  - 英语：Philosophy，哲学。
    ...
    - 魔理沙的魔法书 (未找到链接)中提到[古明地恋](./古明地恋.md)「不认同身边的弹幕」以及「认为自己被厌弃全是因为弹幕之故」，可以视作是她的一种人生处世哲学。
...
- DNAの瑕
  ...
  - 然而突变也被视作物种演化的推动力：一些突变可能反而对生存有利，因此更有可能被遗传给后代。
    ...
    - 参见「胎儿之梦」 (未找到链接)的[分析考据](./胎儿之梦-分析与考据.md)。
...
- 第四阶段：黄色光弹和激光。
  - 代表胎儿出生时，从子宫里出来的一瞬间所感受到的光芒。
    ...
    - 该阶段（以及地灵殿中恋在无意识「弹幕的墨迹测验」 (未找到链接)之后的非符）有些像Treasure发布的弹幕游戏《闪亮银枪》[^cite_note-31]第6关BOSS的部分弹幕。
      - 《闪亮银枪》是制作组负责人井内ひろし经手的第11部作品，而地灵殿 (未找到链接)是东方Project的第11弹作品。
...
- ローズ（rose）
  - 参见「Subterranean Rose」 (未找到链接)的分析考据 (未找到链接)。
...
（地狱）
  ...
  - 日本作家梦野久作的著作多以《XX地狱》的格式命名。
    ...
    - 该小说中提到了一篇名为《胎儿之梦》的论文，其标题出现在古明地恋的另一张符卡「胎儿之梦」 (未找到链接)中，参见[其分析考据](./胎儿之梦-分析与考据.md)。
...
（先祖大人）
  - 日本民间传说，当祖先有事要警告子孙时，会在子孙的梦中出现，集体列队站在子孙的枕头旁。
  - 参见符卡表象「列祖列宗入梦来」 (未找到链接)的[分析考据](./列祖列宗入梦来-分析与考据.md)。
...
- ローズ
  - 英语：Rose，蔷薇。
    ...
    - 本符卡中蔷薇的颜色和路线都和「Subterranean Rose」 (未找到链接)相似。
...
- フロウディアン（Freudian）
  ...
  - 古明地恋的符卡本能「本我的解放」 (未找到链接)和抑制「Super Ego」 (未找到链接)也涉及精神分析学中“本我、自我与超我”的理论。
...
:  **「我是梅莉。现在在你的背后。」** 
  ...
  - 古明地恋的灵异名「メリーさんの電話」（梅莉小姐的电话）、灵异技能「我现在就去你那里哦」和符卡＊被诅咒的响一声电话＊ (未找到链接)都与此传说有关。
...
- イド（id）
  - 拉丁语：（精神分析学）本我。
  - 古明地恋的元素。
  - 参见古明地恋的符卡本能「本我的解放」 (未找到链接)的[分析考据](./本我的解放-分析与考据.md)。

- <ruby lang="ja"><rb>式神</rb><rp> (</rp><rt>しきがみ</rt><rp>) </rp></ruby>

  - 八云蓝的元素。

- 对应古明地觉和八云蓝的符卡地妖符「自我的式神」 (未找到链接)。
...
- コントロール（control）
  - 英语：控制。
  - 也是一个棒球术语，意为「控球能力」。
    - 文花帖中古明地姐妹的其他两张符卡地灵符「Mind Stellar Steal」 (未找到链接)和地灵符「Mind Stellar Relief」 (未找到链接)名字也带有棒球术语，参见[前者的分析考据](./Mind_Stellar_Steal-分析与考据.md)。
...
- 符卡中，恋放出粉红色心弹，觉收回绿色心弹。
  - 分别与恋的符卡本能「本我的解放」 (未找到链接)和抑制「Super Ego」 (未找到链接)相似，颜色也相近。
  - 恋代表放纵的本我，觉代表克制的超我。
...
- 符卡名字大部分与地灵符「Mind Stellar Steal」 (未找到链接)相同，参见[其分析考据](./Mind_Stellar_Steal-分析与考据.md)。
- リリーフ（relief）
  - 英语：缓解；消除；接替。
...
- 该技能中出现的红蓝二色双螺旋，形似DNA。
  - 符卡记忆「DNA的瑕疵」 (未找到链接)也有类似颜色的DNA图案。
