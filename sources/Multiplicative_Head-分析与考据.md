# Multiplicative_Head/分析与考据

<!-- source html: G:\repos\THBWiki-Markdown-Builder\THBWikiMarkdown\Temp\main\5\57\ns0%3AMultiplicative_Head%2F%E5%88%86%E6%9E%90%E4%B8%8E%E8%80%83%E6%8D%AE.html -->
...
- [1 分析与考据](#分析与考据)
  ...
  - [1.1 飛頭「マルチプリケイティブヘッド」](#飛頭「マルチプリケイティブヘッド」)
  - [1.2 飛頭「セブンズヘッド」](#飛頭「セブンズヘッド」)
  - [1.3 飛頭「ナインズヘッド」](#飛頭「ナインズヘッド」)
...
- 可能与日本有名的平将门怨灵[^cite_note-1]有关。
  - 传说平将门被斩首示众后，首级向关东飞去，途中力竭落地，因此在各地衍生了很多首塚传说[^cite_note-2]。
  ...
  - 而与《俵藤太物语》同时期著成的《师门物语》中，记载的是八名影武者。
    - 对应下一张符卡[飞头「Ninth Head」](./Multiplicative_Head.md)中的“ninth”（第九）。
...
- 可能与日本有名的平将门怨灵有关。参见上一张符卡的[飞头「Seventh Head」](./Multiplicative_Head.md)的分析考据 (未找到链接)。
