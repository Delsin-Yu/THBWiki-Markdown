...
```
なんと初版第一巻から10年を経ての
弊サークルの連作東方同人誌「東方怪弾七」です。全132p。

こちらはその総集編単行本「compilation」(全三巻)の
第一巻・微修正版となります。
おまけで単独刊行版「東方怪弾七(1)」「(2)」「Halations.(2)」の
刊行時ままのおはずかしいデータも添付。 
```
