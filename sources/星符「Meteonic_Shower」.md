...
<!-- source html: G:\repos\THBWiki-Markdown-Builder\THBWikiMarkdown\Temp\main\c\ce\ns0%3AMeteonic_Shower.html -->

官方符卡

本页是关于 **[符卡](./符卡.md#符卡)（SpellCard）** 的词条Meteonic Shower（符卡） - 官方符卡
...
<p>星符「Meteonic Shower」（流星雨）
</p>
</th></tr>
<tr>
<td class="jadef" width="50%" lang="ja" style="border-right:none; padding-left:1em;">
<p>前方に大量の弾をばら撒く射撃 燃費が安く気楽に使用が出来る
</p>
</td>
<th style="background:#f9f9f9; border-left:none">
</th>
<td class="zhdef" width="50%" style="padding-left:1em;">
<p>向前方发射出大量散弹攻击。消耗很低，可以轻松随意使用。
</p>
</td></tr></tbody></table>
...
<big>- [分析与考据](./Meteonic_Shower-分析与考据.md)
</big><big></big>  
<big></big>
