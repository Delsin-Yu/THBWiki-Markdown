...
- トンネルエフェクト（tunnel effect）
  - 英语：隧穿效应。
  - 量子隧穿效应（英语：quantum tunnelling effect）[^cite_note-1]
...
[^cite_note-1]: 中文维基百科：[量子穿隧效应](https://en.wikipedia.org/wiki/zh:量子穿隧效应)
