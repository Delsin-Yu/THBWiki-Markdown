...
- ルナダイアル（luna dial、lunar dial）
  ...
  - 月晷[^cite_note-1]与日晷相似，是利用月亮来指示时间的工具。
...
[^cite_note-1]: 中文维基百科：[月晷](https://en.wikipedia.org/wiki/zh:月晷)
