...
- 如果操作正确，将会听到Extend的音效，并解锁所有卡牌、所有符卡练习、所有机体配置的单关练习和Extra难度。但是初始双卡槽（需要通关一次的成就）及三卡槽（需要携带空白卡通关的成就）不会解锁，加油！
...
这些后门由The Cutting Room Floor[^cite_note-3][^cite_note-4]发现并公布。
...
[^cite_note-2]: 别名MARUEFU，即“丸F”的意思，为该啤酒的内部代号，因为推出时广受欢迎而成为公开的代称。
[^cite_note-3]: [https://twitter.com/notrevenant/status/1376282744574128130](https://twitter.com/notrevenant/status/1376282744574128130)
[^cite_note-4]: [https://tcrf.net/Category:Touhou_Project_series](https://tcrf.net/Category:Touhou_Project_series)
