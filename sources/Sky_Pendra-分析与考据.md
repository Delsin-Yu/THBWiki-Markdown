...
- スカイペンドラ
  - 或改写自「スコロペンドラ」，即「Scolopendra」，蜈蚣属。[^cite_note-1]
...
[^cite_note-1]: （英文）英文维基百科：[Scolopendra](https://en.wikipedia.org/wiki/en:Scolopendra)
