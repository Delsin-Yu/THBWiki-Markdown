...
<td><center><big>ルームを作成<span>[^cite_note-1]</span></big><br>Create Room</center>
</td></tr>
<tr>
<td>Online VS Mode</td>
...
<tr>
<td>时间结束<span>[^cite_note-2]</span></td>
...
（喜欢的动物：结果，是猫）<span>[^cite_note-3]</span></center>
</div>
</td></tr>
<tr>
<td class="jadef" width="50%" lang="ja" style="border-right:none; padding-left:1em;">
...
（喜欢的动物：豹纹守宫）<span>[^cite_note-4]</span></center>
</div>
</td></tr>
<tr>
<td class="jadef" width="50%" lang="ja" style="border-right:none; padding-left:1em;">
...
[^cite_note-2]: 判定胜负的标准为“中弹次数>使用C4次数>使用C3次数>剩余攻击槽数值”，如果双方全部相同则为平局。[\[从第二家开始的广播第156回\]](./2軒目から始まるラジオ-内容整理.md#2023/08/31_第156回)
[^cite_note-3]: 在ZUN晒出兽王园正式版盒装CD的[博客](./东方四方山新闻-ZUN博客.md#2023年08月11日)配图中，摆放了一个小猫摆件。
[^cite_note-4]: 在ZUN晒出兽王园体验版碟面的[推文](https://twitter.com/korindo/status/1654633359266709506)配图中，摆放了一个豹纹守宫的小摆件。
