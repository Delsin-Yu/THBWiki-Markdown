...
- [1 分析与考据](#分析与考据)
  ...
  - [1.1 鳥符「ヒューマンケージ」](#鳥符「ヒューマンケージ」)
  - [1.2 鳥符「ヒューマンケージダブル」](#鳥符「ヒューマンケージダブル」)
...
- ダブル（double）
  - 英语；双倍。
  - [鸟符「Human Cage」](./Human_Cage.md)是一只鸟（使魔）释放弹幕，本符卡则是两只。
