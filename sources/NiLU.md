...
<td class="mbox-text" style=""><big>本词条的内容需要进行补充。</big><br><b>本页面需要对于 该角色 方面的内容进行补充</b>。<br>如果您对于相关内容较为了解，请您<a href="/index.php?title=NiLU&amp;action=edit">补充本词条的内容</a></td>
</tr>
</tbody></table>
...
## 角色信息
[](./文件-NiLU（连缘咖啡厅立绘）.png.md)  [](./文件-NiLU（连缘咖啡厅立绘）.png.md)NiLU
<table>
<tbody><tr>
<th colspan="2">基本信息</th>
</tr>
<tr>
<td style="width:120px"><b>人物名</b></td><td style="min-width:300px">Monochroid[niLu] = _Type_iX■[■■■];</td>
...
NiLU最早出现在2019年Jynx上所发布的“世间忙于例大祭，所以随手留下这张对连缘来说意味深长的图片也无人在意”推文中，从图片内容来看，NiLU是“do Not, I Love You”的缩写。  

NiLU喜爱食物，名字音同“煮る”。  

NiLU名字中所含的nil指计算机语言中的无值值，这点和同为黑白机器人的Rei君、Zelo酱和Rin碳相同。  
...
NiLU身穿黑色披风，用分别为白色、紫色、红色、蓝色的四条皮带固定。
