...
- [1 分析与考据](#分析与考据)
  ...
  - [1.1 禁弾「カタディオプトリック」](#禁弾「カタディオプトリック」)
...
- カタディオプトリック（catadioptric）
  - 英语：折反射。
  - 光学上指既有透镜（用于折射）也有面镜（用于反射）的系统，用于折反射望远镜[^cite_note-1]及一些相机镜头中。
  - 该符卡的弹幕特征就是碰到弹幕边缘后反弹。



[^cite_note-1]: 中文维基百科：[折反射望远镜](https://en.wikipedia.org/wiki/zh:折反射望远镜)
