...
- 熔解
  - 物质通过加热、增压，由固态转变为液态的过程。[^cite_note-1]
...
- ホワイト
  - 英语：White，白色。
  - 可能指用于水冷核反应堆的锆合金。[^cite_note-2][^cite_note-3]
...
[^cite_note-1]: 中文维基百科：[熔解](https://en.wikipedia.org/wiki/zh:熔解)
