...
- キャンディッド
  - 英语：Candid，有偷拍、盗摄的含义。
  - 「Candid Photography」（抓拍）是一种摄影技巧，捕捉目标景物一刹那的影像，被广泛应用于现实生活中。[^cite_note-1]
...
[^cite_note-1]: （英文）英文维基百科：[Candid Photography](https://en.wikipedia.org/wiki/en:Candid_Photography)
