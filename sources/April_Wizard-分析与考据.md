...
- [1 分析与考据](#分析与考据)
  ...
  - [1.1 裏春「エイプリルウィザード」](#裏春「エイプリルウィザード」)
  - [1.2 裏春「異常落花の魔術使い」](#裏春「異常落花の魔術使い」)
...
（里）
  - 参见[里夏「Scorch by Hot Summer」](./Scorch_by_Hot_Summer.md)的[分析考据](./Scorch_by_Hot_Summer-分析与考据.md)。
...
い（魔法师）
  - 意同上一张符卡[里春「April Wizard」](./April_Wizard.md)中的“wizard”一词。
