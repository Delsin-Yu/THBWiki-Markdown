...
<tbody><tr>
<td>发生/全体</td>
<td>1F发动，第2F生效<span>[^cite_note-5]</span>/宣言硬直
</td></tr>
<tr>
<td>取消/被取消等级</td>
<td>必杀技/不可被取消
...
与[根性值](./游戏攻略-FTG术语.md#根性)、[生药「国士无双之药」](./国士无双之药.md)、替身娃娃、诹访子的诅咒、各种天气的效果均为乘法叠加。
...
[^cite_note-2]: 即使在防御硬直中，只要不输入防御指令（按4或6），那么就会算作被命中。
[^cite_note-3]: 也就是说1.9张卡的时候使用，最后会变成3.0张（1.10的改动，1.03时是增加相当于2张卡片的符力）。
[^cite_note-4]: 背靠版边时，对打击技发动则没有效果。
[^cite_note-5]: 起身的当F被对手A打到的同时发动，那么对手接下来的招式就肯定会打到霸体上，自己就可以趁机反击。对于hit数少而收招破绽大的技能也可以以此反击。
