# Muscle_Explosion/分析与考据

<!-- source html: G:\repos\THBWiki-Markdown-Builder\THBWikiMarkdown\Temp\main\f\f6\ns0%3AMuscle_Explosion%2F%E5%88%86%E6%9E%90%E4%B8%8E%E8%80%83%E6%8D%AE.html -->
...
- [1 分析考据](#分析考据)
  ...
  - [1.1 勁疾技「マッスルエクスプロージョン」](#勁疾技「マッスルエクスプロージョン」)
  - [1.2 「爆発は筋力だ！」](#「爆発は筋力だ！」)
...
- 爆発
  - 联系符卡劲疾技「Muscle Explosion」 (未找到链接)。

- 爆発は筋力だ！
  - 可能联系了名句「芸術は爆発だ」（艺术就是爆炸）。[^cite_note-1]
    - 最初为日本艺术家冈本太郎的名言，形容艺术灵感的迸发有如爆炸一般。
    - 《火影忍者》中的角色「迪达拉」在形象设计上有许多联系冈本太郎的地方，这句话也作为其标志性台词广为流传。[^cite_note-2]
...
[^cite_note-1]: （日文）日文维基百科：[岡本太郎](https://en.wikipedia.org/wiki/ja:岡本太郎)
