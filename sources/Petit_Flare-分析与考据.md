...
- フレア
  - 英语：Flare，火焰、火光。
  - 也作为“Solar Flare”的简写，意即“太阳耀斑”。[^cite_note-1]
...
- メガ、ギガ、ペタ
  - 分别为Mega、Giga、Peta，汉语中写作“兆”、“吉（咖）”、“拍（它）”。
    - 皆为“国际单位制”（Système International d'Unités，简称SI）中的词头，即“SI词头”，用于构成倍数和分数单位。[^cite_note-2][^cite_note-3]
    - Mega对应10^6，即一兆、一百万；Giga对应10^9，即十亿；Peta对应10^15，即千兆。
    - 国际单位制的源头可以追溯到法国大革命时期开始采用的“公制”，因此词头的词汇都来自法语。


- 自上方落下逐渐变小的火球。
  - 可能取自CAVE/ATLUS于1998年发行的STG《长空超少年》（エスプレイド，ESP Ra.de.）中，最终BOSS卡拉夫人的一身弹幕。[^cite_note-4]


- [](./文件-爆符「Petit_Flare」（地灵殿）.jpg.md)弹幕样式- [](./文件-卡拉夫人弹幕.jpg.md)卡拉夫人弹幕


[^cite_note-1]: 中文维基百科：[太阳耀斑](https://en.wikipedia.org/wiki/zh:太阳耀斑)
