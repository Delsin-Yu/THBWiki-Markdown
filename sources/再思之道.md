...
## 一设资料
### 东方求闻史纪
[](./文件-再思之道（求闻史纪）.jpg.md)  [](./文件-再思之道（求闻史纪）.jpg.md)求闻史纪插图
...
- 在花映塚 (未找到链接)中，可以看到满地的彼岸花，两边有茂密的树木。
