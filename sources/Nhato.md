...
擅长制作电子音乐，尤其以Electro House、Trance风格出名，而且喜欢制作以Trance为主架构的融合风格。
...
电音同人圈里Nhato的粉丝有点多，难以一一列举。
  

Kirin
: 同为wavforme以及ANAGRAM的成员（Kirin在两个团体使用的都是MK名义）。

SoU
: 设计师。wavforme主催。与Nhato一样同时是Otographic Music、ANAGRAM的成员。
