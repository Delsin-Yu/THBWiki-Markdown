...
- セプテントリオン
  ...
  - 在现代英语中已经不再使用 ，作形容词为“Septentrional”，意为“北方的”，较少有人使用。[^cite_note-1]
...
- [东方文花帖DS符卡说明](./东方文花帖DS-符卡说明.md)中提及，跟着的一颗隐星。
  - 北斗七星勺柄处，“开阳星”（大熊座ζ）旁边的一颗较暗的伴星，为大熊座第80号星，称作“开阳增一”或“辅”（Alcor）。[^cite_note-3]
...
[^cite_note-1]: （英文）英文维基百科：[Septentrional](https://en.wikipedia.org/wiki/en:Septentrional)
