...
- ナイトバード（night bird）
  ...
  - [文花帖](./东方文花帖.md)中露米娅有名字相似的符卡[夜符「Midnight Bird」](./Midnight_Bird.md)。
