...
）。
  ...
  - 「のびる」拉长第二个音就成了「のびーる」。
    - 荷取的符卡河童「延展手臂」 (未找到链接)（河童「のびーるアーム」）就有这个词。参见该符卡的分析考据 (未找到链接)。
...
- メア（mare）
  ...
  1 鬼压床的恶灵。也是英语nightmare（恶魔）的口语缩写。
    - 对应该系列中Lunatic难度符卡漂溺「粼粼水底之心伤」 (未找到链接)的「心伤」。
...
- ポロロッカ（Pororoca）
  ...
  - 在[魔理沙的魔法书](./The_Grimoire_of_Marisa-河城荷取.md)中，魔理沙认为“Pororoca”是日语「鉄砲水」的意思。
    - 不过「鉄砲水」的正确英语翻译是“flash flood”（该词在下一张符卡水符「河童之山洪暴发」 (未找到链接)名字中出现）。
...
- <ruby lang="ja"><rb>三平</rb><rp> (</rp><rt>さんぺい</rt><rp>) </rp></ruby>
ファイター
  - 参见战机「飞翔吧！三平加油」 (未找到链接)的[分析考据](./飞翔吧！三平加油-分析与考据.md)。
...
（尼斯湖）[^cite_note-28]
  ...
  - 尼斯湖水怪又被称作「尼西」（Nessie）。详见＊尼西的完全养殖技术＊ (未找到链接)的[分析考据](./尼西的完全养殖技术-分析与考据.md)。
...
- ネッシー
  - 英语：Nessie，尼斯湖水怪。[^cite_note-29]
    - 传说生活在英国苏格兰尼斯湖的水怪，一般被描述成类似蛇颈龙的生物。
      - 蛇颈龙首次出现在三叠纪晚期，而深秘录 (未找到链接)中[河城荷取](./河城荷取.md)的称号正是「太古！三叠纪的河童」。
...
- ミズバク
  - 参见水面符「水泡弹假面舞会」 (未找到链接)的[分析考据](./水泡弹假面舞会-分析与考据.md)。
...
- 参见光学「Optical Camouflage」 (未找到链接)的[分析考据](./Optical_Camouflage-分析与考据.md)。
...
- さよなら
  - 心绮楼 (未找到链接)发布时，《海腹川背》系列的最新作为《再见了海腹川背》（さよなら 海腹川背）[^cite_note-38]。
...
- ミズバク
  - [太东](./太东.md)于1990年发行的横向卷轴游戏『ミズバク大冒険』。参见水面符「水泡弹假面舞会」 (未找到链接)的[分析考据](./水泡弹假面舞会-分析与考据.md)。
...
- ネッシー（Nessie）
  - 尼斯湖水怪。参见＊尼西的完全养殖技术＊ (未找到链接)的[分析考据](./尼西的完全养殖技术-分析与考据.md)。
