# 东方琴鼓歌_~_Thunder_Drum_and_Mysterious_Rhythm
...
动力值会因为**擦弹**，**击打音符的准确值达到 Perfect 或 Great** 时增加，而在**[被弹](./游戏攻略-STG术语.md#Miss)**，**击打音符的准确值为 Bad 或 Miss **时减少。  
...
一部分是右侧的弹幕分，通过**[擦弹](./游戏攻略-STG术语.md#擦弹)**及**吃消弹点道具**获得。  
