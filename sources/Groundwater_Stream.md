...
<!-- source html: D:\Repos\THBWiki-Markdown-Builder\THBWikiMarkdown\Temp\main\b\be\ns0%3AGroundwater_Stream.html -->

官方符卡

本页是关于**[符卡](./游戏攻略-STG术语.md#符卡)（SpellCard）**的词条Groundwater Stream（符卡） - 官方符卡
<table>
...
<tr>
<td>水炮「Groundwater Stream」（地下溪流）</td>
<td>水砲「グラウンドウォーターストリーム」
</td></tr></tbody></table>
...
### 分析考据
<big>
- [分析与考据](./Groundwater_Stream-分析与考据.md)
