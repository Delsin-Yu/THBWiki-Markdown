# Lazy_Trilithon/分析与考据

<!-- source html: G:\repos\THBWiki-Markdown-Builder\THBWikiMarkdown\Temp\main\5\55\ns0%3ALazy_Trilithon%2F%E5%88%86%E6%9E%90%E4%B8%8E%E8%80%83%E6%8D%AE.html -->
...
- [1 考据与分析](#考据与分析)
  ...
  - [1.1 土符「レイジィトリリトン」](#土符「レイジィトリリトン」)
  - [1.2 土符「レイジィトリリトン上級」](#土符「レイジィトリリトン上級」)
  - [1.3 土符「トリリトンシェイク」](#土符「トリリトンシェイク」)
...
- トリリトン（Trilithon）
  - 又称“Trilith”，一种由三块类长方体巨石组合成的构造的称呼。具体构造是由两块竖立于地面上的石块，上面放置一水平石块，形成类似于“冂”字的门形构造。[^cite_note-1]
 ...
 **土符「レイジィトリリトン上級」**   土符「Lazy Trilithon上级」（慵懒三石塔 上级）
...
[^cite_note-1]: （英文）英文维基百科：[Trilithon](https://en.wikipedia.org/wiki/en:Trilithon)
