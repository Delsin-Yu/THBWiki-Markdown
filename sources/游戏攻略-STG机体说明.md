...
设定上，几乎每颗子弹都有各自独立的伤害，并以各自独立的发射间隔射出，而ZUN在程序中设定了各个机体在[每一帧](./游戏攻略-STG术语.md#帧)中能造成的伤害上限。例如[地灵殿的帧伤害上限机制说明](./游戏攻略-STG机体说明-东方地灵殿.md#帧伤害上限机制)。  

因此，在[贴脸、合体](./游戏攻略-STG术语.md#贴脸)或特定站位射击时，在某些个帧数内的伤害会超过上限值而被修正，表现为在一定时间内的实际伤害低于标示值。
...
提到Bomb伤害数据时，如果没有标明，则是特指**bomb本身的总伤害**（即不含持续时间内射击的伤害）。无敌时间单位为**[帧（f）](./游戏攻略-STG术语.md#帧)**。
...
主审：Canaria_19<br>
特别感谢：黑白的魔法少女 MOF 沙砾仔<span>[^cite_note-2]</span>（<a rel="nofollow" class="external text" href="https://space.bilibili.com/2373148">@砂砾籽</a>） 基拉 haclep COOL_FIRE5 盛夏の青空<br>
搬运：雨天放晴<br>
