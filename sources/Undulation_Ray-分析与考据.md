# Undulation_Ray/分析与考据

<!-- source html: G:\repos\THBWiki-Markdown-Builder\THBWikiMarkdown\Temp\main\6\6c\ns0%3AUndulation_Ray%2F%E5%88%86%E6%9E%90%E4%B8%8E%E8%80%83%E6%8D%AE.html -->
...
- [1 分析与考据](#分析与考据)
  ...
  - [1.1 白符「アンデュレイションレイ」](#白符「アンデュレイションレイ」)
...
- 妖妖梦正式版中，这张符卡之后是[怪符「テーブルターニング」](./Table_Turning.md)。
  - 体验版Plus中的则是 **白符「アンデュレイションレイ -Lunatic- 」** （白符「Undulation Ray -Lunatic- 」），也就是本符卡的Lunatic版。
