...
[^cite_note-2]: 关于被动灵界，已知的bug是进入被动灵界可能会造成严重的短暂掉帧，会导致replay播放错误；但是如果在此时手动加速rep播放，之后取消掉则会正常。
[^cite_note-3]: 灵梦变为2way高速御札，没有诱导效果（即加强且加宽了的主炮，中间缝隙也变宽）；魔理沙变为4way高速魔法导弹主炮(子弹贴图比正常状态更大)，中间也有较宽缝隙，同时自机移速增加；早苗变为4way高速蛇弹，没有诱导效果，中间同样有缝隙。妖梦变为连续高速斩击，效果和普通的低速斩击一致，但无需蓄力，按住射击键自动连发。
