...
- [1 分析考据](#分析考据)
  ...
  - [1.1 棒符「ビジーロッド」](#棒符「ビジーロッド」)
  - [1.2 棒符「ナズーリンロッド」](#棒符「ナズーリンロッド」)
...
- ロッド
  - 英语：Rod，杆子。
    - 取自「探宝术/寻水术」（Dowsing）中使用的「占卜杆」（Dowsing Rod）。[^cite_note-1]
...
[^cite_note-1]: （英文）英文维基百科：[Dowsing](https://en.wikipedia.org/wiki/en:Dowsing)
