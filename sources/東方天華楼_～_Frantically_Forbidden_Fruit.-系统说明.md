...
: 增加0.05p。
大红点
: 增加1.00p。在自动收点时记作100个道具。
F点
: 恢复所有Power。在自动收点时记作500个道具。

- 残机减少时会扣除0.50p并掉落5个小红点和3个中红点（共0.20p），当剩余残机为0时会额外掉落F点。大红点只能通过敌人掉落获得。
- 当Power不为满（5.00）时，高速状态下击落敌人会掉落额外的小红点。

### 分数道具
蓝点
: 分数道具。在自动收取的情况下获得等同于当前最大得点值的分数，非自动收取的情况下依照屏幕高度结算得分。
绿点
...
游戏分为两个模式，分别是天华统一模式和传奇模式。无论哪个模式下残机和bomb的上限个数都是5。
  
  
天华统一模式下，残机将以hp条的方式计算，通过奖残扩增生命最大值，奖残时恢复所有体力。不同的子弹伤害也不一样，power会减少相应的伤害值。
  
  
当hp小于0时，残机减一，hp回复至满。进入下一关或者通过果汁的效果也可以增加hp。
  
  
除去残机道具之外，还可以通过打分奖励获取残机。分别在1.5亿，3.5亿，7.5亿，11亿，22亿，33亿，44亿，55亿，66亿，77亿，99亿9999万各获得一个残机。
...
当回收的道具个数满足分母值，且回收条变为0的时候，将会出现分数奖励，并且放出水果道具。
...
画面左侧有一个进度条，每条进度条最多能容纳2.0L的果汁。当进度条满的时候，该果汁的颜色被确定为最后一个回收的道具颜色，并且存入左下角的空瓶子当中；同时进度条清空进行下一条果汁的储存。最多可以存储3瓶果汁（6.0L）。
  
  
当持有1.0升及以上果汁的时候，可以按C键发动果汁的特效。发动时间内自机无敌，并且会使符卡收取分数大幅度上涨。多种果汁的效果可以同时发动，持续时间与该种类果汁的量正相关。
  
  
部分果汁在持续时间内受击会减少持续时间。触发条件目前不明。
...
### 果汁一览
苹果
: <ruby><rb>双倍道具</rb><rp> (</rp><rt>Dual Item</rt><rp>) </rp></ruby>
。回收的道具计数为2倍，对于大P点和F点有效。
橘子
: <ruby><rb>子弹能量</rb><rp> (</rp><rt>Bullet Power</rt><rp>) </rp></ruby>
。对范围内的敌弹消除，并且转化为P点。
香蕉
: <ruby><rb>超级擦弹</rb><rp> (</rp><rt>Super Graze</rt><rp>) </rp></ruby>
。擦弹范围大幅度提升。
西瓜
: <ruby><rb>射击增幅</rb><rp> (</rp><rt>Hpyer Shot</rt><rp>) </rp></ruby>
。射击威力大幅度上升。
蜜瓜
: <ruby><rb>符卡上涨</rb><rp> (</rp><rt>Spellgauge Up</rt><rp>) </rp></ruby>
。恢复1条符卡槽。具体恢复量可能与说明不同。
葡萄
: <ruby><rb>敌人减速</rb><rp> (</rp><rt>Slow Enemy</rt><rp>) </rp></ruby>
。敌人的移动速度，子弹速度以及Boss自爆计时器速度减半。
桃子
: <ruby><rb>生命恢复</rb><rp> (</rp><rt>Life Max</rt><rp>) </rp></ruby>
。生命值全回复，并赋予生命持续恢复的效果。
杨桃
...
<table><tbody><tr><td style="min-width:200px" colspan="2" align="center"><b>基本性能</b></td><td style="min-width:150px" colspan="2" align="center" lang="ja"><b>基本性能</b></td></tr><tr><td style="min-width:125px"><b>移动速度</b></td><td style="min-width:125px">4.50（像素/帧）</td><td style="min-width:100px" lang="ja">4.50[dot/frame]</td></tr><tr><td style="min-width:125px"><b>特技</b></td><td style="min-width:125px"></td><td style="min-width:100px" lang="ja">当たり判定が小さい</td></tr>
<tr><td style="min-width:200px" colspan="2" align="center"><b>装备内容</b></td><td style="min-width:150px" colspan="2" align="center" lang="ja"><b>装備内容</b></td></tr><tr><td style="min-width:125px"><b>高速射击</b></td><td style="min-width:125px"></td><td style="min-width:100px" lang="ja">ホーミングアミュレット</td></tr><tr><td style="min-width:125px"><b>描述</b></td><td style="min-width:125px"></td><td style="min-width:100px" lang="ja">ゆっくり飛んでいくホーミング弾を発射する。
威力はそれほどでもない。</td></tr><tr><td style="min-width:125px"><b>低速射击</b></td><td style="min-width:125px"></td><td style="min-width:100px" lang="ja">パスウェイジョンニードル</td></tr><tr><td style="min-width:125px"><b>描述</b></td><td style="min-width:125px"></td><td style="min-width:100px" lang="ja">前方に長い針を高速で投げつける
撃破に困ったらコレに頼ろう。</td></tr><tr><td style="min-width:125px"><b>高速Bomb</b></td><td style="min-width:125px"></td><td style="min-width:100px" lang="ja">霊符「夢想封印」(Cost:50)</td></tr><tr><td style="min-width:125px"><b>描述</b></td><td style="min-width:125px"></td><td style="min-width:100px" lang="ja">特大ホーミング弾を敵にお見舞いする。
毎度おなじみ、霊夢の代名詞のスペルカード</td></tr><tr><td style="min-width:125px"><b>低速Bomb</b></td><td style="min-width:125px"></td><td style="min-width:100px" lang="ja">神技「八方龍殺陣」(Cost:100)</td></tr><tr><td style="min-width:125px"><b>描述</b></td><td style="min-width:125px"></td><td style="min-width:100px" lang="ja">霊夢の周囲に強靭な結界を生み出す。
ゲージ消費に見合った無敵時間と破壊力を持つ。</td></tr><tr><td style="min-width:125px"><b>特征</b></td><td style="min-width:125px"></td><td style="min-width:100px" lang="ja">ゆっくり適当に追尾するホーミング攻撃と、
<p>前方高速連射攻撃がセットになった標準的装備。
</p><p><br>
無敵時間が長めのボムと万能性が魅力だが、遠くからだと
</p>
...
<tr><td style="min-width:200px" colspan="2" align="center"><b>装备内容</b></td><td style="min-width:150px" colspan="2" align="center" lang="ja"><b>装備内容</b></td></tr><tr><td style="min-width:125px"><b>高速射击</b></td><td style="min-width:125px"></td><td style="min-width:100px" lang="ja">イリュージョンレーザー</td></tr><tr><td style="min-width:125px"><b>描述</b></td><td style="min-width:125px"></td><td style="min-width:100px" lang="ja">絶え間なく一瞬で画面端に届く貫通レーザーを照射
敵に近づくと赤く色づいて攻撃力が上がる特性を持つ。</td></tr><tr><td style="min-width:125px"><b>低速射击</b></td><td style="min-width:125px"></td><td style="min-width:100px" lang="ja">スターダストミサイル</td></tr><tr><td style="min-width:125px"><b>描述</b></td><td style="min-width:125px"></td><td style="min-width:100px" lang="ja">加速しながら飛んでいくミサイル弾を前方に発射。
敵に当たると爆風が炸裂して周囲を巻き込む。</td></tr><tr><td style="min-width:125px"><b>高速Bomb</b></td><td style="min-width:125px"></td><td style="min-width:100px" lang="ja">恋符「マスタースパーク」(Cost:60)</td></tr><tr><td style="min-width:125px"><b>描述</b></td><td style="min-width:125px"></td><td style="min-width:100px" lang="ja">超強力な極太レーザーを前方にぶっ放す。
原作より展開時間が短くなっているので注意。</td></tr><tr><td style="min-width:125px"><b>低速Bomb</b></td><td style="min-width:125px"></td><td style="min-width:100px" lang="ja">彗星「ブレイジングスター」(Cost:120)</td></tr><tr><td style="min-width:125px"><b>描述</b></td><td style="min-width:125px"></td><td style="min-width:100px" lang="ja">光を纏いながら画面上に特攻する体当たり攻撃
マスタースパークよりも長時間、画面全体を攻撃できる。</td></tr><tr><td style="min-width:125px"><b>特征</b></td><td style="min-width:125px"></td><td style="min-width:100px" lang="ja">広範囲を貫通照射するレーザーと
<p>敵を巻き込む爆裂ミサイルがセットになった前方攻撃特化装備。
</p><p><br>
...
<table><tbody><tr><td style="min-width:200px" colspan="2" align="center"><b>基本性能</b></td><td style="min-width:150px" colspan="2" align="center" lang="ja"><b>基本性能</b></td></tr><tr><td style="min-width:125px"><b>移动速度</b></td><td style="min-width:125px">4.50（像素/帧）</td><td style="min-width:100px" lang="ja">4.50[dot/frame]</td></tr><tr><td style="min-width:125px"><b>特技</b></td><td style="min-width:125px"></td><td style="min-width:100px" lang="ja">アイテムの落下が遅い</td></tr>
<tr><td style="min-width:200px" colspan="2" align="center"><b>装备内容</b></td><td style="min-width:150px" colspan="2" align="center" lang="ja"><b>装備内容</b></td></tr><tr><td style="min-width:125px"><b>高速射击</b></td><td style="min-width:125px"></td><td style="min-width:100px" lang="ja">スローイングナイフ</td></tr><tr><td style="min-width:125px"><b>描述</b></td><td style="min-width:125px"></td><td style="min-width:100px" lang="ja">広範囲に刺さるナイフをばら撒く。
高速左右移動で発射基準角度を変える事が出来る。</td></tr><tr><td style="min-width:125px"><b>低速射击</b></td><td style="min-width:125px"></td><td style="min-width:100px" lang="ja">シルバーリコシェ</td></tr><tr><td style="min-width:125px"><b>描述</b></td><td style="min-width:125px"></td><td style="min-width:100px" lang="ja">画面左右端で反射するナイフを発射する。
反射後は、敵に当たると爆発するようになる。</td></tr><tr><td style="min-width:125px"><b>高速Bomb</b></td><td style="min-width:125px"></td><td style="min-width:100px" lang="ja">幻符「殺人ドール」(Cost:45)</td></tr><tr><td style="min-width:125px"><b>描述</b></td><td style="min-width:125px"></td><td style="min-width:100px" lang="ja">敵目掛けて突撃するナイフを大量設置。
単体火力は低いので、ショットと併用するのがオススメ。</td></tr><tr><td style="min-width:125px"><b>低速Bomb</b></td><td style="min-width:125px"></td><td style="min-width:100px" lang="ja">時符「デュアルスクウェア」(Cost:90)</td></tr><tr><td style="min-width:125px"><b>描述</b></td><td style="min-width:125px"></td><td style="min-width:100px" lang="ja">触れた敵弾の時間を操り、現在・未来で二度消す。
大量のアイテムが手に入り、更に敵へ攻撃する事も可能。</td></tr><tr><td style="min-width:125px"><b>特征</b></td><td style="min-width:125px"></td><td style="min-width:100px" lang="ja">広範囲かつテクニカルに攻撃するナイフと
<p>反射する爆裂ナイフがセットになった広範囲装備。
</p><p><br>
</p><p>かなりの範囲をカバーできるが、その分火力は低め。
</p>
...
<tr><td style="min-width:200px" colspan="2" align="center"><b>装备内容</b></td><td style="min-width:150px" colspan="2" align="center" lang="ja"><b>装備内容</b></td></tr><tr><td style="min-width:125px"><b>高速射击</b></td><td style="min-width:125px"></td><td style="min-width:100px" lang="ja">コバルトスプレッド</td></tr><tr><td style="min-width:125px"><b>描述</b></td><td style="min-width:125px"></td><td style="min-width:100px" lang="ja">敵に当たると炸裂する蛙ショットを発射。
広範囲に高い威力の攻撃が出来るが、着弾速度に難アリ。</td></tr><tr><td style="min-width:125px"><b>低速射击</b></td><td style="min-width:125px"></td><td style="min-width:100px" lang="ja">スカイサーペント</td></tr><tr><td style="min-width:125px"><b>描述</b></td><td style="min-width:125px"></td><td style="min-width:100px" lang="ja">ショットが敵と同じ高さまで進むと食らい付くように方向を変える。
数が多い分、一発当たりの火力は安い。</td></tr><tr><td style="min-width:125px"><b>高速Bomb</b></td><td style="min-width:125px"></td><td style="min-width:100px" lang="ja">蛇符「神代大蛇」(Cost:70)</td></tr><tr><td style="min-width:125px"><b>描述</b></td><td style="min-width:125px"></td><td style="min-width:100px" lang="ja">物凄く大きな大蛇を呼び出して、一瞬で全画面攻撃を行う。
判定が出るまでが早いので、すぐに弾を消したい時に。</td></tr><tr><td style="min-width:125px"><b>低速Bomb</b></td><td style="min-width:125px"></td><td style="min-width:100px" lang="ja">蛙符「手管の蝦蟇」(Cost:140)</td></tr><tr><td style="min-width:125px"><b>描述</b></td><td style="min-width:125px"></td><td style="min-width:100px" lang="ja">３つの光を時間差で炸裂させる超高火力全画面攻撃。
炸裂するまでが遅い為、タイミングが悪いと無駄撃ちに終わる事も。</td></tr><tr><td style="min-width:125px"><b>特征</b></td><td style="min-width:125px"></td><td style="min-width:100px" lang="ja">広範囲で炸裂する蛙爆弾と
<p>横限定の高速サーチショットのいいとこどり装備。
</p><p><br>
</p><p>低速移動がサーチショットなので、避けに専念できる。
</p>
