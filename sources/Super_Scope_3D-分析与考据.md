# Super_Scope_3D/分析与考据

<!-- source html: G:\repos\THBWiki-Markdown-Builder\THBWikiMarkdown\Temp\main\d\d0\ns0%3ASuper_Scope_3D%2F%E5%88%86%E6%9E%90%E4%B8%8E%E8%80%83%E6%8D%AE.html -->
...
- スーパースコープ（Super Scope）
  - 光线枪。任天堂发行的「超级任天堂」（第二代家用游戏机）的周边机器，形似步枪[^cite_note-1]。
...
[^cite_note-1]: 日文维基百科：[スーパースコープ](https://en.wikipedia.org/wiki/ja:スーパースコープ)
