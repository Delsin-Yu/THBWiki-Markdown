...
本页是关于东方Project  
 **官方旧作登场角色 (未找到链接)** 的词条苏格拉底（旧作角色，旧作） - 旧作官方角色
## 目录
...
## 一设资料
### 东方梦时空
[](./文件-苏格拉底（梦时空立绘）.png.md)  [](./文件-苏格拉底（梦时空立绘）.png.md)东方梦时空立绘
#### Omake
