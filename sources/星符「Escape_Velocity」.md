...
<!-- source html: G:\repos\THBWiki-Markdown-Builder\THBWikiMarkdown\Temp\main\9\93\ns0%3AEscape_Velocity.html -->

官方符卡

本页是关于 **[符卡](./符卡.md#符卡)（SpellCard）** 的词条Escape Velocity（符卡） - 官方符卡
...
<p>星符「Escape Velocity」（第二宇宙速度）
</p>
</th></tr>
<tr>
<td class="jadef" width="50%" lang="ja" style="border-right:none; padding-left:1em;">
<p>ミアズマスウィープを大幅改良 接近状態でのカウンターや上空の 敵を討ち取るのに効果を発揮
</p>
</td>
<th style="background:#f9f9f9; border-left:none">
</th>
<td class="zhdef" width="50%" style="padding-left:1em;">
<p>大幅改良后的Miasma Sweep。无论是近距离的反击还是追讨上空敌人效果都很好。
</p>
</td></tr></tbody></table>
...
<big>- [分析与考据](./Escape_Velocity-分析与考据.md)
</big><big></big>  
<big></big>
