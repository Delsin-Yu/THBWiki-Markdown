...
<td>主动技能</td>
<td>通关星期日弹幕梦2</td>
<td>允许通过照相的方式消弹，以及对BOSS产生大量伤害。<br>BOSS离照片中心越近伤害越高。<br><b>注意：</b>本作通关条件为<b>击破BOSS前至少拍摄一张照片</b>，最终分数和最终照片强制取得分最高的一张。<br>与<a href="./东方文花帖.md" class="mw-redirect" title="文花帖">文花帖</a>和<a href="./东方文花帖DS.md" class="mw-redirect" title="文花帖DS">文花帖DS</a>不同的是，本作的照片留存条件不再限制为“必须拍到BOSS”，只要是主动拍照产生的照片均可以留存并参与结算。
</td></tr>
<tr>
<td>Level 2</td>
<td><div class="tt-zhh tt-type-omake" lang="zh"><div class="poem"><ruby>
