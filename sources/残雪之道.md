...
- “残雪”与星莲船 (未找到链接)游戏的背景设定有关，设定上此时是初春时节，冬雪消融，但尚未完全进入春天。

```
土地变得泥泞，曾被寒冰覆盖的大地上，万物开始复苏。
覆盖着幻想乡的少量积雪，封住了在这个冬天苏醒的地灵们，也足以使妖精们的活动变得迟钝。
这样安稳沉睡的季节也即将告一段落。
……
...
## 结构与造型
### 设定点
- 这条道路在星莲船 (未找到链接)游戏中一直作为背景存在，在一面、二面、三面、EX面都有这条道路出现。
...
### 游戏内图像
- [](./文件-残雪之道（星莲船一面场景）.jpg.md)残雪之道（星莲船一面场景）
