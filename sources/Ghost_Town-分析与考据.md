...
- [文花帖DS](./东方文花帖DS.md)中，如果自机拍到阿燐的猫形态，会获得名为“Cat Bonus (未找到链接)”的奖励，分值为666分。
...
[^cite_note-1]: 中文维基百科：[鬼城](https://en.wikipedia.org/wiki/zh:鬼城)
