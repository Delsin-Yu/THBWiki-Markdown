...
- <ruby lang="ja"><rb>恋符</rb><rp> (</rp><rt>れんふ</rt><rp>) </rp></ruby>
  ...
  - 本符卡和[恋符「Master Spark」](./恋符「Master_Spark」.md)一样使用激光，因此前缀相同。
...
- [仪符「Orrery's Sun」](./仪符「Orrery's_Sun」.md)和[天仪「Orrery's Solar System」](./天仪「Orrery's_Solar_System」.md)的升级版，参见前者的分析考据 (未找到链接)。
- ユニバース（universe）
  - 英语：宇宙。
...
- ショート（short）
  ...
  - 电路短路（short circuit）的略称。
    - 发生短路时通常会产生电弧，导致火花（spark）生成 → 魔理沙的符卡[恋符「Master Spark」](./恋符「Master_Spark」.md)。
...
- ウェーブ（wave）
  - 可能出自[太东](./太东.md)于1986年发售的街机横向射击游戏《大流士》（日语：ダライアス，英语：DARIUS）[^cite_note-21]。
    ...
    - 而[星莲船](./星莲船.md)中，魔理沙的基本射击是Missile，寻找宝物类型的子机火力是Laser，满足好奇类型的子机火力是Wave。
...
- エコー（echo）
  - 英语：回声；共鸣，附和。
  - 引申为重复、仿效。
    - 魔理沙对其他人的模仿，例如[恋符「Non-Directional Laser」](./恋符「Non-Directional_Laser」.md)模仿了帕秋莉的弹幕，参见[该符卡的分析考据](./Non-Directional_Laser-分析与考据.md)。
...
- 符卡名大多与[光击「Shoot the Moon」](./光击「Shoot_the_Moon」.md)相同，参见其分析考据 (未找到链接)。
- リトル（little）
  - 英语：小。
...
（闭）
  - 闭合宇宙。
    - 本符卡与[魔开「Open Universe」](./魔开「Open_Universe」.md)相反，参见[其分析考据](./Open_Universe-分析与考据.md)。
...
- ビッグクランチ（Big Crunch）
  ...
  - 详见[魔开「Open Universe」](./魔开「Open_Universe」.md)的[分析考据](./Open_Universe-分析与考据.md)。
...
」。
  - 开放宇宙。参见下文。
    - 本符卡与[闭符「Big Crunch」](./闭符「Big_Crunch」.md)相反，参见[其分析考据](./Big_Crunch-分析与考据.md)。
...
- オープンユニバース（open universe）
  ...
  - 不同的全局形状意味着宇宙最终会有不同的结局。根据曲率，宇宙的形状可被归为三类：
    ...
    - 闭合宇宙（closed universe）：
      ...
      - 「大坍缩」的英语是“Big Crunch” → [闭符「Big Crunch」](./闭符「Big_Crunch」.md)。
...
- ペルセイド（perseid）
  ...
  - [妖精大战争](./妖精大战争.md)于[C78](./Comiket.md)发行，日期是2010年8月13日至15日，正好处于英仙座流星雨的高潮。
...
- 符卡名大多与[彗星「Blazing Star」](./彗星「Blazing_Star」.md)相同，参见其分析考据 (未找到链接)。
...
さん（厕所里的花子）
  ...
  - [文花帖DS](./文花帖DS.md)中[封兽鵺](./封兽鵺.md)的符卡[真相不明「厕所里的花子」](./真相不明「厕所里的花子」.md)也引用了该传说，参见[其分析考据](./厕所里的花子-分析与考据.md)。
...
- オカルテイション（occultation）
  ...
  - 该词是由“occult”+名词后缀“-ation”组成的。
    - “occult”意即[深秘录](./深秘录.md)的主题「灵异」。除此之外也有「掩蔽、隐藏」的意思。
...
- スレイブ（slave）
  - 英语：奴隶，使役。
  - [凭依华](./东方凭依华.md)中的下仆。
  - 魔理沙的使魔。参见符卡[魔弹「Test Slave」](./魔弹「Test_Slave」.md)的[分析考据](./Test_Slave-分析与考据.md)。

- スパーク（spark）
  - 英语：火花。
  - 魔理沙有很多的用到“spark”一词的符卡，参见[恋符「Master Spark」](./恋符「Master_Spark」.md)。
...
- スパーク
  - 英语：Spark，火花。
    - [雾雨魔理沙](./雾雨魔理沙.md)有很多的用到「Spark」一词的符卡，参见[恋符「Master Spark」](./恋符「Master_Spark」.md)。
...
- アステロイドベルト（asteroid belt）
  - 英语：小行星带。
  - 参见[符之二「Asteroid Belt」](./符之二「Asteroid_Belt」.md)的分析考据 (未找到链接)。
...
- 参见[黑魔「Event Horizon」](./黑魔「Event_Horizon」.md)的分析考据 (未找到链接)。
...
- 参见[光符「Earth Light Ray」](./光符「Earth_Light_Ray」.md)的分析考据 (未找到链接)。
...
- [爱丽丝·玛格特洛依德](./爱丽丝·玛格特洛依德.md)支援的远程灵击。
  - 出自[爱丽丝·玛格特洛依德](./爱丽丝·玛格特洛依德.md)的符卡[魔符「Artful Sacrifice」](./魔符「Artful_Sacrifice」.md)，参见[其分析考据](./Artful_Sacrifice-分析与考据.md)。
...
- [河城荷取](./河城荷取.md)支援的远程灵击。
  - 出自[河城荷取](./河城荷取.md)的符卡[光学「Optical Camouflage」](./光学「Optical_Camouflage」.md)，参见[其分析考据](./Optical_Camouflage-分析与考据.md)。
...
- 参见[星符「Meteonic Shower」](./星符「Meteonic_Shower」.md)的[分析考据](./Meteonic_Shower-分析与考据.md)。
...
- 参见[魔废「Deep Ecological Bomb」](./魔废「Deep_Ecological_Bomb」.md)的[分析考据](./Deep_Ecological_Bomb-分析与考据.md)。
