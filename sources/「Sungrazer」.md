...
本页是关于 **[符卡](./符卡.md#符卡)（SpellCard）** 的词条Sungrazer（符卡） - 官方符卡
...
<div class="poem">
<p>乗っている箒で周辺をなぎ払って相手を打ち上げ、<br>
无防备なところに最大推力で突进打击を见舞う大技です。<br>
なぎ払いは攻击范囲が広く、<br>
攻击中の魔理沙は无敌という頼れる技です。
</p>
</div>
...
<div class="poem">
<p>用所乘的扫帚横扫周围将对手打上半空，<br>
趁其毫无防备之时使用最大推力进行突进攻击的大招。<br>
横扫的攻击范围很广，<br>
攻击中的魔理沙无敌，是一个很可靠的技能。
</p>
</div>
