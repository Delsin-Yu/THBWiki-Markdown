...
<!-- source html: G:\repos\THBWiki-Markdown-Builder\THBWikiMarkdown\Temp\main\3\3b\ns0%3ASatellite_Illusion.html -->

官方符卡

本页是关于 **[符卡](./符卡.md#符卡)（SpellCard）** 的词条Satellite Illusion（符卡） - 官方符卡
...
<tr>
<td>星符「Satellite Illusion」（卫星幻觉）</td>
<td>星符「サテライトイリュージョン」
</td></tr></tbody></table>
...
<p>星符「Satellite Illusion」
</p>
</th></tr>
<tr>
<td class="jadef" width="50%" lang="ja" style="border-right:none; padding-left:1em;">
<div class="poem">
<p>宣言時に衛星ビットを召還。自身に従わせつつ<br>
近寄る相手を自動的に攻撃させ、使用すれば<br>
ビット回転でのフィニッシュ攻撃になる<br>
<br>
宣言時点で攻撃が始まるため、通常の<br>
スペルカードより宣言時間が短い点は注意
</p>
</div>
</td>
...
<big>- [分析与考据](./Satellite_Illusion-分析与考据.md)
</big><big></big>  
<big></big>
