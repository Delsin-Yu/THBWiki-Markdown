...
- 如果金钱数不够，可以将火力值超过1.00的部分兑换为金钱强行购买，每0.01火力值可兑换1金钱。购买时直接扣除火力值，无法选择具体兑换数额。如果加上超过1.00的额外火力仍然不够则会显示不能购买。透支火力购买卡牌后金钱清零。
...
<td>是</td>
<td><div class="tt-zh tt-type-omake" lang="zh"><div class="poem">驹草山如的能力，可以让生命徐徐增加<br>成功收取符卡时会出现生命的碎片<br>　<br>状态良好时生命也会增加，高歌猛进的能力<br>“工作做得好，烟草抽得饱”<span>[^cite_note-2]</span></div></div>
</td></tr>
<tr>
<td>43</td>
...
<td></td>
<td><div class="tt-zh tt-type-omake" lang="zh"><div class="poem">姬虫百百世的能力，<a href="./游戏攻略-STG术语.md#花式打法" title="游戏攻略/STG术语">No Miss No Bomb</a>时会变得更强。<br>击败敌人时攻击力会逐渐上升，但<br>中弹或使用符卡后就会复原。<br>节约符卡的意义又多了一个。<br>这就是会令人紧张到神经刺痛的蜈蚣的毒。</div></div>
</td></tr>
<tr>
<td>44</td>
...
<td>240</td>
<td>使用咲夜通关一次游戏</td>
<td>咲夜的变种子机。<br>2way散射飞刀，会在左右版边弹射。<br>全部命中火力也是第一梯队，但是不容易打到人。<br>槽位中第一张卡为各类子机时会出现发弹位置错误的BUG。<span>[^cite_note-3]</span>
</td></tr>
<tr>
<td>15</td>
<td>平安归来蛙护身符</td>
...
<td>280</td>
<td>购买对应卡牌</td>
<td>自机正下方一定距离处获得有一定宽度、可持续消弹的“背后之门”。<br>范围为长20.0，宽6.0的矩形。<br>有那么一点点点攻击判定，撞一秒左右可以撞死1面小妖精的程度。<br>6面1、2符特解。<br>与跳弹飞刀有类似的bug，被称作“半灵变门术”。<br>配合疾风木屐缩小判定点，可以操控门与判定重合。<span>[^cite_note-4]</span>
</td></tr>
<tr>
<td>21</td>
<td>恼人的UFO</td>
...
<td>100</td>
<td>初始解锁</td>
<td>MISS不会损失财力。<br><a href="./游戏攻略-STG术语.md#被弹Bomb" class="mw-redirect" title="决死">决死</a>允许时间由8帧（约0.13秒）提高到15帧（0.25秒）。
</td></tr>
<tr>
<td>27</td>
<td>弱肉强食之理</td>
...
<td>180</td>
<td>购买对应卡牌</td>
<td>主炮射击的伤害提高40%<span>[^cite_note-火力-5]</span>，主炮子弹的判定范围扩大50%。不影响子机及道具。<br>灵梦、咲夜的主炮射击伤害会比黑白和早苗高接近40%，因此加成也会高一些。<br>对灵梦咲夜而言，提升的火力也是第一梯队的。
</td></tr>
<tr>
<td>28</td>
<td>法力经典</td>
...
<td>100</td>
<td>购买对应卡牌</td>
<td>中弹后损失的火力从1.00降低至0.50。<span>[^cite_note-保P-6]</span><br>免疫杂兵的体术。对Boss没有效果。
</td></tr>
<tr>
<td>30</td>
<td>爆裂赤蛙</td>
...
<td>100</td>
<td>购买对应卡牌</td>
<td>松开射击和低速键时立即进入超高速移动状态（和地灵殿不同，没有延迟）。<br>移动速度为每帧9像素，开始移动时获得4<a href="./游戏攻略-STG术语.md#帧" title="游戏攻略/STG术语">帧</a>无敌（可叠加）<span>[^cite_note-7]</span>。<br>只要不按下低速键（不管是射击还是移动都无所谓），<a href="./游戏攻略-STG判定数据.md" title="游戏攻略/STG判定数据">判定</a>就会缩小至1.0<span>[^cite_note-8]</span>。
</td></tr>
<tr>
<td>32</td>
<td>偶像防卫队</td>
...
<td>350</td>
<td>购买对应卡牌</td>
<td>撞到子机的子弹会被消除（对卡片子机无效），每次生效只能撞掉1颗子弹。<br>各个子机的判定和冷却时间互相独立。<br>冷却时间6秒，可以从子机周围的光圈判断是否冷却完毕。<span>[^cite_note-9]</span>
</td></tr>
<tr>
<td>33</td>
<td>辉夜姬的秘密宝箱</td>
...
<td>350</td>
<td>购买对应卡牌</td>
<td>获得时增加1.00火力（所以初始携带的话会2P开局）<br>中弹不会使火力降低至3.00以下，低于3.00时中弹不会损失火力。<br>只保护中弹减少火力的情形，使用道具卡或是商店透支火力是不受保护的。<span>[^cite_note-保P-6]</span>
</td></tr>
<tr>
<td>35</td>
<td>弹幕的亡灵</td>
...
<td>240</td>
<td>购买对应卡牌</td>
<td>每擦过5个子弹后，会将第6个擦过的子弹消除。对激光无效。<br>常规情况下无法消除的子弹也可以被此特效消除。<br>比如魅须丸的阴阳玉。<br>利用这张卡可以在五面终符的星弹中吃出大缝<span>[^cite_note-10]</span>。
</td></tr>
<tr>
<td>36</td>
<td>鬼杰组长的恐吓</td>
...
<td>100</td>
<td>购买对应卡牌</td>
<td>持有该卡时，每个关卡开始时增加1个符卡（初始携带也可）<span>[^cite_note-11]</span>。<br>EX关卡中，购买该卡之后什么事也不会发生。（但钱变少了呢）
</td></tr>
<tr>
<td>40</td>
<td>擅长做生意的招财猫</td>
...
<td>300</td>
<td>通关一次EXTRA关卡</td>
<td>对敌人造成伤害则会逐渐增加所有射击的威力，<br>计数器完全取决于造成了伤害的帧数目，不一定要靠射击造成伤害。<br>最多会使攻击力变为1.8倍<span>[^cite_note-火力-5]</span>，当前攻击力倍率会显示在卡片下方。<br>MISS或者使用BOMB（包括灵力瓶）则效果重置为1.000。<br>鬼推磨及回避药的灵击及地底太阳不会触发重置效果。<br>播放录像时，攻击力加成会在关卡结束后重置，因此会引发播放错误。<span>[^cite_note-12]</span>
</td></tr>
<tr>
<td>44</td>
<td>画面的界线</td>
...
<td>180</td>
<td>初始解锁</td>
<td>一定延迟后将前方的子弹转化为道具。<br>有36.67%的概率转化为黄点，63.33%的概率转化为绿点<span>[^cite_note-13]</span>。<br>冷却时间40秒。
</td></tr>
<tr>
<td>46</td>
<td>忍耐的要石</td>
...
<td>400</td>
<td>购买对应卡牌</td>
<td>在0.66秒延迟后发动全屏光束攻击。<br>总计会完全随机地消除场上约80%的子弹（对激光无效），并造成些许伤害。<span>[^cite_note-14]</span><br>效果共持续2秒，持续时间结束后开始计算冷却。冷却时间30秒。
</td></tr>
<tr>
<td>49</td>
<td>Vampire Fang</td>
...
<td>240</td>
<td>购买对应卡牌</td>
<td>0.5秒延迟后，向前方近距离发动尖牙突刺。<br>牙齿会跟随自机移动，持续时间约0.8秒，伤害极高且可以抵消弹幕。<br>持续时间内会提高自机每帧最高伤害的上限值。<span>[^cite_note-15]</span><br>发动延迟中没有消弹判定（而且特效贴图会遮挡弹幕）。<br>冷却时间20秒。
</td></tr>
<tr>
<td>50</td>
<td>地底的太阳</td>
...
<td>450</td>
<td>购买对应卡牌</td>
<td>召唤逐渐变大的地底太阳，最大半径略大于版面长边，<br>展开总时间约10秒，达到最大时立刻消失，<br>接触到太阳圆周与内部的子弹会被消除，该范围内敌人会受到伤害。<br>效果发动中全程无敌，伤害极高，对于杂鱼几乎是秒杀，<br>对BOSS可以连续烧掉接近两管完整的血条。<br>但发动期间会持续损失火力值。<br>共损失1.02P左右，火力不会降到1以下，1.00~2.01P也可以正常发动。<br>在符卡战中使用此卡片<span>[^cite_note-16]</span>则会直接判定符卡收取失败。<br>冷却时间300秒。<br>在虹人环击破前使用会击破boss导致后续的符卡全部被跳过，立即通关<span>[^cite_note-17]</span>。
</td></tr>
<tr>
<td>51</td>
<td>道具的季节</td>
...
<td>300</td>
<td>购买对应卡牌</td>
<td>召唤有一定耐久度、会发射自机狙<span>[^cite_note-18]</span>攻击玩家的莉莉白，<br>击破后掉落1个符卡碎片。<br>每使用2次后，第三次会召唤莉莉黑，掉落残机碎片。<br>每次使用本卡牌，莉莉的装饰弹数量和发弹频率都会提高，血量也会略微增加。<span>[^cite_note-19]</span><br>最多存在30秒，且会被剧情清屏效果以及击破符卡/非符的消弹强制删除（且无掉落）。<br>冷却时间120秒，从召唤时开始计算。因此实际上获得不了多少资源。<br>丢B的时候顺便召唤出来一起炸掉就好了♪
</td></tr>
<tr>
<td>52</td>
<td>重低音大鼓</td>
...
<td>180</td>
<td>购买对应卡牌</td>
<td>在自机当前位置展开一个持续2秒的圆形结界，消除接触到的敌弹（激光不受影响）。<br>被消除的子弹会转化为冰晶弹并沿着接触点对应的结界半径方向向外高速射出，<br>每颗子弹都是单独的判定。<br>和地灵殿的反射不同，贴发弹点使用也可以正常生效<span>[^cite_note-20]</span>。<br>表现为，在发动前已经进入判定范围内的子弹也会被消除，<br>并沿着对应的半径方向向外射出，发射的起始点在判定圆周上。<br>冷却时间25秒。
</td></tr>
<tr>
<td>54</td>
<td>灵力的标本瓶</td>
...
[^cite_note-2]: 江户谚语，比喻在休息之前需保证工作万无一失。
[^cite_note-3]: 槽位中第一张卡有类似“子机”的属性（包括绿UFO、人偶、半灵、勾玉等）时，如果之后获得了跳弹卡片，那么跳弹的飞刀会从第一张卡的子机（而不是角色身后的咲夜子机）处发射。这一类bug的出现情况很多，包括把背后门装备到UFO上这种奇葩情况。
[^cite_note-4]: 只要不是同帧miss这种情况，几乎是全方位立体防御。具体可参考[这篇专栏](https://www.bilibili.com/read/cv11428896)与[这一神迹](https://www.bilibili.com/video/av632982585)。
[^cite_note-火力-5]: 同时携带狼头及蜈蚣时，主炮伤害加成按照后获得的计算。例如先获得蜈蚣后买了狼头，主炮火力会被锁死为+40%而不会受蜈蚣卡影响。
[^cite_note-保P-6]: 同时携带狸子和帽子时，保P效果只有后获得的有效。例如先获得帽子后买了狸子（初始卡槽也是按顺序的），则中弹损失1P但不会掉落至3P以下。反之，中弹只损失0.5P但会掉落至3P以下。
[^cite_note-7]: 虽然极短时间内移动、停止、移动可叠加无敌时间，甚至使用符卡和中弹后的无敌也可以用木屐特效来延续，但几乎只有借助辅助程序才可以达成，手操需要约900APM的按键速度。
[^cite_note-8]: 通常情况下，全机体的判定相同，都是3.0
[^cite_note-9]: 只要携带了该卡，即使火力变化导致子机消失，或者还没有升到足够高的火力，未显示的子机的消弹冷却也是正常计时的。
[^cite_note-10]: 这样的话还可以内避哦。参考[这个](https://www.bilibili.com/video/av333463080)。
[^cite_note-11]: 虽然文本描述和地藏几乎相同，但是关底买它并不会获得1（获得）+1（奖励）个。推测是只有“关卡开始时”才会给，而获得时啥也不给。
[^cite_note-12]: 当前版本（1.00a）存在此BUG。不过录像本身没有损坏，使用[thprac的附带功能修正](./游戏攻略-STG常用工具.md#练习器与查看器)后可以正常播放。
[^cite_note-13]: 具体而言，每五颗子弹中，第2,4个必定会转化为绿点，第1个必定会转化为黄点，第3个有50%概率转化为绿点，50%概率转化为黄点，第5个有2/3的概率转化为绿点，1/3概率转化为黄点
[^cite_note-14]: 具体而言，启动后第40f判定第一次，之后每8f判定一次，总共10次。每次判定时，遍历全场子弹并从0开始编号a，a随机递增1/2/3。之后消除所有编号能被7整除的子弹。
[^cite_note-15]: 咲夜的符卡为短时高伤，由于帧上限的存在导致实际伤害很低，但如果此时使用牙齿则可以大幅增加伤害。别的机体符卡伤害本就不低，牙齿则常用来代替符卡。
[^cite_note-16]: 或是进入符卡时卡片效果尚未结束
[^cite_note-17]: 根据测试，是同时开启了thprac的卡片无冷却功能导致的，常规实战不会出现。
[^cite_note-18]: 以及一圈等分圆周的装饰弹
[^cite_note-19]: 第⑨只就是最高强度，之后不会再提升。
[^cite_note-20]: 不存在地灵殿梦B的Bomb那样，堵死发弹量过大的发弹源，反倒反射不了几颗子弹的情况，或许是引擎性能的进步。
